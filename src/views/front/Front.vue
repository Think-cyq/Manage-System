  ...
  <div>
    ...
    <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
      <div style="width: 300px; display: flex; padding-left: 30px">
        ...
        <div class="title">动漫世界</div>
      </div>
      <div style="flex: 1">

        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" router>
          <el-menu-item index="/front/home">首页</el-menu-item>
          <el-menu-item index="/front/video">视频区</el-menu-item>
          <el-menu-item index="/front/article">评论区</el-menu-item>
          <el-menu-item index="/front/film">动漫区</el-menu-item>
          <el-submenu index="2">
            <template slot="title">游戏区</template>
          ...
          <el-menu-item index="4"><a href="https://www.bilibili.com/" target="_blank">更多</a></el-menu-item>
        </el-menu>
      </div>
...
.title {
  color: #FFC1C1;
  font-family: "Roboto Slab", cursive, sans-serif; /* 使用可爱的字体 */
